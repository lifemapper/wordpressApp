...
function CLifemapperScreen() {
    ...
    function ExecuteList(a, b, c, d, e) { for (var i = 0; i < a.length; i++) { a[i](b, c, d, e); } };
    ...
    this.AddSpecies = function (d) {
        ExecuteList(speciesHandler.add, d);
    ...
    this.ShowSpecies = function (d) {ExecuteList(speciesHandler.show, d); };
    ...
    var myTest = 0;
    this.UpdateExperiment = function (a, b, c, d) {
        myTest += 1;
        ExecuteList(experimentHander.update, a, b, c, d);
    };
