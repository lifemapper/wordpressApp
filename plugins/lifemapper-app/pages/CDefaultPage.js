...
$(function () {
    ...
    climateLayersDialog.ShowDialog = function () {
        var url = lmConstants.urlBase + "?page_id=883";
    ...
    var speciesSelector = new CSpeciesSelector("#species-archive", true);
    ...
    myExperimentListDialog = new CDialogWithHelp("#my-experiment", { width: 400, height: 400 }, "#how-to-view-experiment", { minWidth: 750, height: 610 });
    ...
    InstallHelpButton(helpDialogGroup, ".my_experiment_new_help_button", "#my-experiments-new-message", { width: 550, height: 450 });
