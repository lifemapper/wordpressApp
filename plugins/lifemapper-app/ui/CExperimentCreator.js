function CExperimentCreator(selector) {
   ...
   var speciesSelector = new CSpeciesSelector(selector, false);
   ...
   function EnableButton() {
      if (ValidateInput().length == 0) {
         ...
         btnRunModel.attr("src", lmConstants.pluginDir + "images/run_experiment.png?v=3.9");
      }
      else {
         btnRunModel.enabled = false;
         btnRunModel.attr("src", lmConstants.pluginDir + "images/run_experiment_inactive.png?v=3.9");
      }
   }
         ...
         if (message.length == 0) {
            ...
            $.postJSON(url, postData, function (e) {
               ...
               lifemapper.ShowUserExperiment(e);
                        ...
                        //alert(textStatus);
                        alert("Sorry, an error occurred.  Please email lifemapper@ku.edu and include the following message: " + errorThrown);
                     });
         }
      }
   }
   ...
   btnRunModel.mouseenter(function () {
      if (btnRunModel.enabled) {
         btnRunModel.attr("src", lmConstants.pluginDir + "images/run_experiment_hover.png?v=3.9");
      }
   });
