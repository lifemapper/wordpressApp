      ...
      if (selectedFileType.length == 0) {
         ...
         reader.onload = (function(theFile) {
            return function(e) {
               ...
               var ft = fileType.val();
               var dn = nameInput.val();
                  
               var postUrl = "http://svc.lifemapper.org/services/sdm/occurrences/json?pointsType=" + ft + "&displayName=" + dn;
               ...
               $.ajax({
                  ...
                  var respObj = $.parseJSON(data.responseText);
                  ProcessOccurrenceSet(respObj.id);
               });
            };
         })(f);
